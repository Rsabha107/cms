            ...
            <ul class="navbar-nav flex-column" id="navbarVerticalNav">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link dropdown-indicator  label-1" href="#nv-MDS" role="button" data-bs-toggle="collapse" aria-expanded="true" aria-controls="nv-MDS">
                            <div class="d-flex align-items-center">
                                <div class="dropdown-indicator-icon-wrapper"><span class="fas fa-caret-right dropdown-indicator-icon"></span></div><span class="nav-link-icon"><span data-feather="phone"></span></span><span class="nav-link-text">CMS</span>
                            </div>
                        </a>
                        <div class="parent-wrapper label-1">
                            <ul class="nav collapse parent {{ Request::is('cms/admin/create')||Request::is('cms/admin/orders/create') ? 'show' : '' }}" data-bs-parent="#navbarVerticalCollapse" id="nv-MDS">
                                <li class="collapsed-nav-item-title d-none">CMS
                                </li>
                                <li class="nav-item"><a class="nav-link {{ Request::is('cms/admin/orders') ? 'active' : '' }}" href="{{route('cms.admin.orders')}}">
                                        <div class="d-flex align-items-center"><span class="nav-link-text">List of Orders</span>
                                        </div>
                                    </a>
                                    <!-- more inner pages-->
                                </li>
                                {{-- <li class="nav-item"><a class="nav-link {{ Request::is('mds/admin/booking/create') ? 'active' : '' }}" href="{{route('mds.admin.booking.create')}}">
                ...
                <li class="nav-item">
                    ...
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('cms/setting/event') ? 'active' : '' }}" href="{{route('cms.setting.event')}}" role="button" data-bs-toggle="" aria-expanded="false">
                    ...
                    <!-- parent pages-->
                    <div class="nav-item-wrapper"><a class="nav-link label-1 {{ Request::is('cms/setting/vehicle') ? 'active' : '' }}" href="{{route('cms.setting.vehicle')}}" role="button" data-bs-toggle="" aria-expanded="false">
