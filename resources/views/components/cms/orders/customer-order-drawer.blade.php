                            ...
                            <table class="table table-hover" id="add_item">
                                <thead>
                                    <tr>
                                        ...
                                        <th scope="col" class="fs-9 lh-sm" style="width:10%">Service Date</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:15%">Product</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:10%">Service Time</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:15%">Venue</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:15%">Location</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:5%">Quantity</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:5%">Chicken</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:5%">Beef/Lamb</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:5%">Vegetarian</th>
                                        <th scope="col" class="fs-9 lh-sm" style="width:8%">Unite Price</th>
                                ...
                                <tbody>
                                    <tr id="row_1">
                                        ...
                                        {{-- </td> --}}
                                        <td>
                                            <input class="form-control quantity form-control-sm" type="number" min="1" 
                                                value="1" name="quantity[]" id="quantity_1" required>
                                        </td>
                                        <td>
                                            <input class="form-control  form-control-sm" type="number" min="1"
                                                value="1" name="chicken_quantity[]" id="chicken_quantity_1"
                                                required>
                                        </td>
                                        <td>
                                            <input class="form-control  form-control-sm" type="number" min="1"
                                                value="1" name="meat_quantity[]" id="meat_quantity_1" required>
                                        </td>
                                        <td>
                                            <input class="form-control  form-control-sm" type="number" min="1"
                                                value="1" name="vegetarian_quantity[]"
                                                id="vegetarian_quantity_1" required>
                                        </td>
                                        <td>
...
<script type="text/javascript">
    ...
    var SmartAuto = (function() {
        ...
        function formHtml() {
            ...
            html +=
                '                                <input class="form-control quantity form-control-sm" type="number" min="1"'
            html += '                                    value="1" name="quantity[]" id="quantity_' + rowCount +'"'
            html += '                                    required>'
            html += '                            </td>'
            ...
            html +=
                '                                <input class="form-control form-control-sm" type="number" min="1"'
            html += '                                    value="1" name="chicken_quantity[]" id="chicken_quantity_' + rowCount +'"'
            html += '                                    required>'
            html += '                            </td>'

            html += '                            <td>'
            html += '                                <input class="form-control form-control-sm" type="number" min="1"'
            html += '                                    value="1" name="meat_quantity[]" id="meat_quantity_' + rowCount +'"'
            html += '                                    required>'
            html += '                            </td>'
            html += '                            <td>'
            html +='                                <input class="form-control form-control-sm" type="number" min="1"'
            html += '                                    value="1" name="vegetarian_quantity[]" id="vegetarian_quantity_' + rowCount +'"'
            html += '                                    required>'
            html += '                            </td>'
            // html += '<td>'
            // html += '   <div class="col-sm-6 col-md-12">'
        ...
        function autoFillItem() {
            ...
            // console.log(rowNo)
            $.ajax({
                url: "/cms/customer/item/get/" + itemId,
                method: "GET",
                async: false,
