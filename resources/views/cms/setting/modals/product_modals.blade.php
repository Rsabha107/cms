<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-edit-product-modal" tabindex="-1"
...
<div class="offcanvas offcanvas-end offcanvas-global-modal in" id="offcanvas-add-product-modal" tabindex="-1"
    ...
    <x-cms.settings.product-drawer id="" formAction="{{ route('cms.setting.product.store') }}"
        formId="add_booking_slot_form" :products="$products" :unitTypes="$unit_types"/>
</div>
