<div class="modal fade" id="create_event_modal" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="form_submit_event" action="{{route('cms.setting.event.store')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_event_modal" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
            ...
            <form novalidate="" class="modal-content form-submit-event needs-validation" id="edit_form_submit_event" action="{{route('cms.setting.event.update')}}" method="POST">
                @csrf
...
<div class="modal fade" id="edit_event_modalxx" tabindex="-1" data-bs-backdrop="static" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content bg-100">
