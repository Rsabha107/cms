            ...
            <div class="row min-vh-100 flex-center p-5">
                <div class="col-12 col-xl-10 col-xxl-8">
                    ...
                    <div class="col-12 col-lg-6 text-center text-lg-start"><img
                            ...
                            src="{{ asset('fnx/assets/img/spot-illustrations/1.png') }}" alt="" /><img
                            class="img-fluid mb-6 w-50 w-lg-75 d-light-none"
                            src="{{ asset('fnx/assets/img/spot-illustrations/dark_404.png') }}" alt="" />
                        ...
                        <p class="text-white mb-2 fw-bold">Please choose an event from the list below.</p>
                            <p class="text-white d-none d-sm-block">If the list is empty or the event is missing, please click on 'request access' and one of our team members will get back to you shortly.
                        </p>
                        @php
                        ...
                        <div
                            ...
                            <form class="position-relative" action="{{ route('cms.customer.orders.event.switch') }}" method="POST">
                                @csrf
                                ...
                                <button class="btn btn-subtle-primary w-100 mb-3" type="submit">Choose Event</button>
                            </form>
                        </div>
                        <a class="btn btn-lg btn-secondary w-100" href="{{ route('cms.customer') }}">Request Access</a>
                    </div>
                </div>
            </div>
        </div>
