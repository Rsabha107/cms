...
use App\Http\Controllers\Cms\Admin\OrderController as AdminOrderController;
use App\Http\Controllers\Cms\Customer\OrderController as CustomerOrderController;
use App\Http\Controllers\Cms\Setting\EventController;
...
use App\Http\Controllers\Mds\Operator\OperatorController;
...
Route::get('/', function () {
    if (auth()->check()) {
        if (auth()->user()->is_admin) {
            ...
            return redirect()->route('cms.customer');
        }
    } else {
...
Route::group(['middleware' => 'prevent-back-history', 'XssSanitizer'], function () {
    ...
    Route::middleware(['auth', 'otp', 'mutli.event', 'XssSanitizer', 'firstlogin', 'role:SuperAdmin|SuperMDS',  'prevent-back-history', 'auth.session'])->group(function () {
        ...
        //     Route::post('/import', 'import')->name('mds.setting.schedule.import.store');
        //     Route::get('/export', 'export')->name('mds.setting.schedule.export.store');
        // });
        ...
        Route::controller(VenueController::class)->group(function () {
            Route::get('/cms/setting/venue', 'index')->name('cms.setting.venue');
            Route::get('/cms/setting/venue/list', 'list')->name('cms.setting.venue.list');
            Route::get('/cms/setting/venue/get/{id}', 'get')->name('cms.setting.venue.get');
            Route::post('cms/setting/venue/update', 'update')->name('cms.setting.venue.update');
            Route::delete('/cms/setting/venue/delete/{id}', 'delete')->name('cms.setting.venue.delete');
            Route::post('/cms/setting/venue/store', 'store')->name('cms.setting.venue.store');
        });
        ...
        Route::controller(EventController::class)->group(function () {
            Route::get('/cms/setting/event', 'index')->name('cms.setting.event');
            Route::get('/cms/setting/event/list', 'list')->name('cms.setting.event.list');
            Route::get('/cms/setting/event/get/{id}', 'get')->name('cms.setting.event.get');
            Route::post('cms/setting/event/update', 'update')->name('cms.setting.event.update');
            Route::delete('/cms/setting/event/delete/{id}', 'delete')->name('cms.setting.event.delete');
        ...
        Route::controller(AppSettingController::class)->group(function () {
            Route::get('/mds/setting/application', 'index')->name('mds.setting.application');
            Route::get('/mds/setting/application/list', 'list')->name('mds.setting.application.list');
            Route::get('/mds/setting/application/get/{id}', 'get')->name('mds.setting.application.get');
            Route::post('mds/setting/application/update', 'update')->name('mds.setting.application.update');
            Route::delete('/mds/setting/application/delete/{id}', 'delete')->name('mds.setting.application.delete');
            Route::post('/mds/setting/application/store', 'store')->name('mds.setting.application.store');
        });
    ...
    Route::middleware(['auth', 'otp', 'mutli.event', 'XssSanitizer', 'role:Customer', 'prevent-back-history', 'auth.session'])->group(function () {
        ...
        Route::controller(CustomerBookingController::class)->group(function () {
            ...
            // Route::get('/mds/customer/booking/confirmation', 'confirmation')->name('mds.customer.booking.confirmation');


            Route::controller(CustomerOrderController::class)->group(function () {
                Route::get('/cms/customer/', 'index')->name('cms.customer');
                Route::get('/cms/customer/orders/', 'index')->name('cms.customer.orders');
                Route::get('/cms/customer/orders/list/{id?}', 'list')->name('cms.customer.orders.list');
                Route::post('/cms/orders/customer/store', 'store')->name('cms.orders.customer.store');
                Route::post('/cms/orders/update', 'update')->name('cms.orders.update');
                Route::get('/cms/customer/orders/mv/edit/{id}', 'get')->name('cms.customer.orders.mv.get');
                Route::delete('/cms/customer/orders/delete/{id}', 'destroy')->name('cms.customer.orders.delete');
                Route::get('/cms/customer/item/get/{id}', 'getItem')->name('cms.customer.item.get');
                Route::get('/cms/customer/orders-order/{id}', 'viewPo')->name('cms.customer.orders.order');
                Route::get('/cms/customer/orders/po/pdf/{id?}', 'orderPDF')->name('cms.customer.orders.po.pdf');
                Route::get('/cms/customer/orders/po/pdf/download/{id?}', 'downloadordersPDF')->name('cms.customer.orders.po.pdf.download');

                Route::get('/download-qr-pdf', 'downloadQrPdf')->name('cms.customer.orders.voucher.qr.pdf');

                Route::get('/cms/customer', 'index')->name('cms.customer');
                Route::get('/cms/customer/events/{id}/switch',  'switch')->name('cms.customer.orders.switch');
    ...
    // Route::middleware(['auth', 'otp', 'mutli.event', 'XssSanitizer', 'role:Manager', 'prevent-back-history', 'auth.session'])->group(function () {
...
Route::group(['middleware' => 'prevent-back-history'], function () {
    ...
    Route::middleware(['auth', 'prevent-back-history'])->group(function () {
        ...
        Route::get('/cms/customer/orders/pick', function () {
            return view('/cms/customer/orders/pick');
        })->name('cms.customer.orders.pick')->middleware('role:Customer');
        Route::post('/cms/customer/events/switch', [CustomerOrderController::class, 'pickEvent'])->name('cms.customer.orders.event.switch')->middleware('role:Customer');
    ...
    // file manager routes
    Route::middleware(['auth', 'otp', 'XssSanitizer', 'role:SuperAdmin|Procurement', 'prevent-back-history', 'auth.session'])->group(function () {
